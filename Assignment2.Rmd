...
ggplot(Kristian_grid,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Kristian")

Josh_grid =grid_function(uniform_prior, 160, 198)

ggplot(Josh_grid,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Josh")

Mikkel_grid=grid_function(uniform_prior, 66, 132)

ggplot(Mikkel_grid,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Mikkel")

# To find out who is best using HPDI
Mikkel_samples = sample(p_grid, prob = Mikkel_grid$posterior, size = 1e4, replace = TRUE)

Josh_samples = sample(p_grid, prob = Josh_grid$posterior, size = 1e4, replace = TRUE)

Kristian_samples = sample(p_grid, prob = Kristian_grid$posterior, size = 1e4, replace = TRUE)
...
ggplot(Riccardo_opt,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Riccardo")

Kristian_opt=grid_function(optimistic_prior, 2, 2)

ggplot(Kristian_opt,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Kristian")

Josh_opt =grid_function(optimistic_prior, 160, 198)

ggplot(Josh_opt,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability")+ ggtitle("Josh")

Mikkel_opt=grid_function(optimistic_prior, 66, 132)

ggplot(Mikkel_opt,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Mikkel")
...
K_opt_plot=ggplot(Kristian_opt100,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Kristian")

R_opt_plot=ggplot(Riccardo_opt100,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Riccardo")

J_opt_plot=ggplot(Josh_opt100,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Josh")

M_opt_plot=ggplot(Mikkel_opt100,aes(grid,posterior))+  geom_point()+geom_line()+theme_classic()+  geom_line(aes(grid,prior/dens),color='red')+  xlab("Knowledge of CogSci")+ ylab("posterior probability") + ggtitle("Mikkel")
...
We would use a skeptic prior (fx mean=0.5, sd = 0.1) indicating that we think their answer will be at chance level. 
